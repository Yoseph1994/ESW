    ...
    <motion.div variants={containerVariants} initial="hidden" animate="visible">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <motion.div variants={itemVariants}>
          <Card
            className="glass-card glass-card-hover border-white/5 cursor-pointer transition-all duration-300 hover:scale-[1.02] shadow-lg shadow-teal-500/10"
            ...
            <CardContent className="p-8">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-5xl font-bold text-white">{newCasesCount}</p>
                  <p className="text-xs text-gray-500 mt-2">
                    {MOCK_NEW_CASES.length} unassigned · {MOCK_ASSIGNED_CASES.length} assigned
                  </p>
                </div>
                <div className="h-16 w-16 rounded-2xl bg-gradient-to-br from-teal-400 to-teal-600 flex items-center justify-center shadow-lg shadow-teal-500/30">
        ...
        <motion.div variants={itemVariants}>
          <Card
            className="glass-card glass-card-hover border-white/5 cursor-pointer transition-all duration-300 hover:scale-[1.02] shadow-lg shadow-emerald-500/10"
            ...
            <CardContent className="p-8">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-5xl font-bold text-white">{completedCount}</p>
                  <p className="text-xs text-gray-500 mt-2">
