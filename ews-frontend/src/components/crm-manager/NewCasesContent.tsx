    ...
    },
    {
      ...
      cell: ({ row }) => (
        <Button
          ...
          className="bg-gradient-to-r from-purple-500 to-fuchsia-600 hover:from-purple-600 hover:to-fuchsia-700 text-white text-xs shadow-lg shadow-purple-500/20 px-4"
        >
  ...
  return (
    <div>
      <Card className="glass-card">
        ...
        <CardContent>
          {/* Tab Buttons */}
          <div className="flex gap-1 mb-6 p-1 bg-gray-50/50 rounded-xl w-fit border border-gray-100">
            <button
        ...
        <div className="space-y-5">
          ...
          <div className="p-4 rounded-xl bg-purple-50/50 border border-purple-100 space-y-2">
            <div className="flex justify-between">
              ...
              <span className="text-sm text-gray-900 font-medium">{selectedCase?.caseNumber}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-xs text-gray-500">Customer</span>
              <span className="text-sm text-gray-900">{selectedCase?.customerName}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-xs text-gray-500">Approve Amount</span>
          ...
          <div className="space-y-2">
            <Label className="text-gray-700">Select CRM Officer</Label>
            <Select value={selectedOfficerId} onValueChange={(v) => setSelectedOfficerId(v ?? '')}>
              <SelectTrigger className="bg-white border-gray-200 text-gray-900 focus:ring-purple-500">
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <Button
              ...
              className="bg-gradient-to-r from-purple-500 to-fuchsia-600 hover:from-purple-600 hover:to-fuchsia-700 text-white shadow-lg shadow-purple-500/20"
            >
